...
export default function EmployeeSalary() {
  ...
  const handelsubmit = async () => {
    ...
    const response = await fetch('http://localhost:8000/api/employees/EmployeeSalary.php', {
      method: 'GET',
      credentials: "include",
      headers: {
  ...
  const handelsubmitt = async () => {
    ...
    const response = await fetch('http://localhost:8000/api/employees/EmployeeProfile.php', {
      method: 'POST',
      credentials: "include",
      headers: {
        'Content-Type': 'application/json'
