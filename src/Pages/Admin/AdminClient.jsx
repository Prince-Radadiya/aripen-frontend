...
export default function AdminClient() {
  ...
  const handelsubmit = async () => {
    ...
    const response = await fetch('http://localhost:8000/api/Admin/AdminClient.php', {
      method: 'GET',
      credentials: "include",
      headers: {
  ...
  const handeladdClient = async (e) => {
    ...
    const response = await fetch('http://localhost:8000/api/Admin/AdminAddClient.php', {
      method: 'POST',
      credentials: "include",
      headers: {
        'Content-Type': 'application/json'
  ...
  const handelRemoveClient = async (clientId) => {
    const response = await fetch('http://localhost:8000/api/Admin/AdminRemoveClient.php', {
      method: 'POST',
      credentials: "include",
      headers: {
        'Content-Type': 'application/json'
